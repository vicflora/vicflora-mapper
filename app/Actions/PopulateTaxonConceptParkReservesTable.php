...
class PopulateTaxonConceptParkReservesTable {
                ...
                ->chunk(100, function($rows) {
                    ...
                    $select = DB::table('taxon_occurrences_materialized_view as tco')
                            ->join('mapper_overlays.park_reserves as pr', function($query) {
                                $query->where(DB::raw("public.ST_DWithin(tco.geom, pr.geom, 0)"), true);
                            })
                    ...
                    DB::table('taxon_concept_park_reserves')->insertUsing([
                        'taxon_concept_id',
                        'park_reserve_id',
                        'occurrence_status',
                        'establishment_means',
